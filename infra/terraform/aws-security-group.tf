...
resource "aws_security_group" "mixfast_security_group_java" {
  name        = "${var.name}_lambda_security_group_java"
  description = "Grupo de seguranca da lambda mixfast authorizer Java"
  vpc_id      = var.vpc_id
